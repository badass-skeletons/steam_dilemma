...
function __wbg_adapter_30(arg0, arg1) {
    const ret = wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h65e1739549be9c9f_multivalue_shim(arg0, arg1);
    if (ret[1]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('steam_dilemma_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
